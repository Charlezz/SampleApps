...
/**
 * Created by Charles on 20/04/2017.
 */
...
public class Square {
    ...
    GLSurfaceView.Renderer mMainGLRenderer;

    public Square(GLSurfaceView.Renderer mMainGLRenderer) {
        this.mMainGLRenderer = mMainGLRenderer;
